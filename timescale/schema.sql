...
CREATE TABLE IF NOT EXISTS player.character (
  ...
  alliance_id INTEGER REFERENCES player.alliance(esi_alliance_id),
  birthday TIMESTAMPTZ,
  bloodline_id INTEGER,
  corporation_id INTEGER REFERENCES player.corporation(esi_corporation_id),
  description TEXT,
  esi_deleted boolean,
  faction_id INTEGER REFERENCES universe.faction(esi_faction_id),
...
CREATE TABLE IF NOT EXISTS player.corporation (
  ...
  alliance_id INTEGER REFERENCES player.alliance(esi_alliance_id),
  ceo_id INTEGER REFERENCES player.character(esi_character_id),
  creator_id INTEGER REFERENCES player.character(esi_character_id),
...
CREATE TABLE IF NOT EXISTS player.alliance (
  ...
  creator_corporation_id INTEGER REFERENCES player.corporation(esi_corporation_id),
  creator_id INTEGER REFERENCES player.character(esi_character_id),
  date_founded TIMESTAMPTZ,
  executor_corporation_id INTEGER REFERENCES player.corporation(esi_corporation_id),
  faction_id INTEGER REFERENCES universe.faction(esi_faction_id),
  name TEXT,
  ticker TEXT,
  created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
