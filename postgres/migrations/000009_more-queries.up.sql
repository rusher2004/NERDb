...
CREATE INDEX attacker_esi_faction_id_index ON killmail.attacker (esi_faction_id);

CREATE INDEX victim_esi_faction_id_index ON killmail.victim (esi_faction_id);
